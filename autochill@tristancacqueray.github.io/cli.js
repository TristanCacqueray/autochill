...
var new_ = (name2) => () => Gio.Settings.new(name2);
...
var unsafe_show = (widget) => () => widget.show();
var unsafe_hide = (widget) => () => widget.hide();
...
var new_2 = (orientation) => (spacing) => () => Gtk42.Box.new(orientation, spacing);
...
var new_with_label = (txt) => () => Gtk43.Button.new_with_label(txt);

// output/Gtk4.DrawingArea/foreign.js
import Gtk44 from "gi://Gtk?version=4.0";
var new_4 = () => Gtk44.DrawingArea.new();
...
var set_text = (eb) => (txt) => () => eb.set_text(txt, txt.length);

// output/Gtk4.Label/foreign.js
import Gtk46 from "gi://Gtk?version=4.0";
var new_6 = (txt) => () => Gtk46.Label.new(txt);
      ...
      var graph = function(x) {
        return function(y) {
          return function __do() {
            ...
            traverse_2(segment(cutoff)(slope)(x)(y))(map2(toNumber)(range2(0)(round2(x))))();
            return stroke(cr)();
          };
        };
      };
...
var mkPrefWidget = function(settings) {
        ...
        return function(cutoff) {
          return function(slope) {
            return function __do() {
              ...
              $$void2(set_int(settings)("duration")(round2(duration)))();
              $$void2(set_double(settings)("cutoff")(cutoffV))();
              $$void2(set_double(settings)("slope")(slopeV))();
              (function() {
                if (workValueM instanceof Just) {
                  return $$void2(set_int(settings)("work-temp")(workValueM.value0))();
                }
                ;
              ...
              (function() {
                if (chillValueM instanceof Just) {
                  return $$void2(set_int(settings)("chill-temp")(chillValueM.value0))();
                }
                ;
              ...
              return log2("applied " + (show1(duration) + (" " + (show22(workValueM) + (" " + show22(chillValueM))))))();
            };
          };
        };
      };
  ...
  return function __do() {
    ...
    var apply3 = new_with_label("Apply")();
...
var getColorSettings = /* @__PURE__ */ $$new2("org.gnome.settings-daemon.plugins.color");

// output/Gio.DBusCallFlags/foreign.js
import Gio3 from "gi://Gio";
var DBusCallFlags = Gio3.DBusCallFlags;
var none = DBusCallFlags.NONE;

// output/Gio.DBusConnection/foreign.js
import Gio4 from "gi://Gio";
var DBus = Gio4.DBus;
var DBusConnection = Gio4.DBusConnection;
...
var new_7 = () => Gio5.Cancellable.new();
      ...
      var go = function(startTime) {
        return function(lastTimeRef) {
          var getSetting = function(name2) {
            return map3(toNumber)(get_int(settings.settings)(name2));
          };
          ...
          return function __do() {
            ...
            log2("AutoChill running for " + (show4(elapsed) + (" sec ( remaining: " + (show4(duration - elapsed) + ") ")) + (" idle: " + show12(idleTime) + (" temp: " + show4(newTemp) + (function() {
              if (idle) {
                return " idle";
              }
              ;
...
var mkWidget = function(settings) {
  return function(env) {
    var onSnooze = function(win) {
      return function __do() {
        hide2(win)();
        return $$void3(timeoutAdd(env.snoozeDelay)(function __do2() {
          showWidget(win)();
          return false;
        }))();
      };
    ...
    var onChilled = function(win) {
      return function __do() {
        hide2(win)();
        autoChillWorker(settings)(env)(show5(win))();
        return unit;
      };
    };
    return function __do() {
      ...
      var box = $$new3(1)(5)();
      var label = $$new6("Time for a break?")();
      append3(box)(label)();
      var actionBox = $$new3(0)(5)();
      var chillButton = new_with_label("I feel chilled")();
      var snoozeButton = new_with_label("Snooze!")();
      $$void3(signal_connect_closure3(chillButton)("clicked")(onChilled(win)))();
      $$void3(signal_connect_closure3(snoozeButton)("clicked")(onSnooze(win)))();
...
var new_9 = () => GLib4.MainLoop.new(null, false);
...
var new_10 = (name2) => () => Gtk410.Application.new(name2, Gio6.ApplicationFlags.FLAGS_NONE);
var run3 = (app) => () => app.run([]);

// output/Gtk4.Application/index.js
var $$new10 = new_10;

// output/AutoChillCLI/index.js
var signal_connect_closure4 = /* @__PURE__ */ signal_connect_closure();
var set_title3 = /* @__PURE__ */ set_title();
var set_child3 = /* @__PURE__ */ set_child();
var show6 = /* @__PURE__ */ show2();
  ...
  var activate = function(_loop) {
    return function(settings) {
      return function __do() {
        ...
        var widget = mkWidget(settings)(env)();
        if (env.debug) {
          return showWidget(widget)();
        }
        ;
        return autoChillWorker(settings)(env)(showWidget(widget))();
      };
    };
  };
