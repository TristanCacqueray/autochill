  ...
  var removePanelMenu = function (env) {
      return function __do() {
          ...
          (function () {
              ...
              throw new Error("Failed pattern match at AutoChill.PanelMenu (line 43, column 3 - line 45, column 45): " + [ buttonM.constructor.name ]);
          })();
...
(function($PS) {
  ...
  var isScreenLocked = function (c) {
      return function (ref) {
          ...
          return simpleCall(c)("org.gnome.ScreenSaver")("/org/gnome/ScreenSaver")("GetActive")(writeCb);
      };
  };
...
(function($PS) {
  ...
  var stopChillWorker = function (env) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at AutoChill.Worker (line 36, column 3 - line 38, column 43): " + [ timerM.constructor.name ]);
      };
  };
  ...
  var minute_sec = (function () {
          ...
          var go = function (settings) {
              return function (screenLockedRef) {
                          ...
                          return function (lastTimeRef) {
                              return function (cancellable) {
                                  ...
                                  return function __do() {
                                      ...
                                      AutoChill_DBus.isScreenLocked(cancellable)(screenLockedRef)();
                                      AutoChill_DBus.getIdleTime(cancellable)(idleTimeRef)();
                                      ...
                                      var reset = Effect_Ref.read(env.reset)();
                                      ...
                                      var shouldStop = elapsed >= duration || (screenLocked || (idle || (reset || asleep)));
                                      ...
                                      if (shouldStop) {
                                          Gio_Cancellable.cancel(cancellable)();
                                          Effect_Ref.write(false)(env.reset)();
                                          show_dialog();
                                          return false;
                                      };
          ...
          return function __do() {
              ...
              if (settingsM instanceof Data_Maybe.Just) {
                  var timer = GLib.timeoutAdd(1000)(go(settingsM.value0)(screenLockedRef)(idleTimeRef)(startTime)(lastTimeRef)(cancellable))();
              ...
              throw new Error("Failed pattern match at AutoChill.Worker (line 55, column 3 - line 60, column 25): " + [ settingsM.constructor.name ]);
          };
      };
  };
