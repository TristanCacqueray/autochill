...
(function($PS) {
  ...
  var setColor = function (colorSettings) {
      return function (value) {
          return function __do() {
              ...
              Gio_Settings.set_value(colorSettings)("night-light-temperature")(v)();
              return Data_Unit.unit;
          };
      };
  };
  var enableNightLight = function (colorSettings) {
      return function __do() {
          ...
          Gio_Settings.set_value(colorSettings)("night-light-schedule-from")(v)();
          var v$prime = GLib_Variant.new_double(24.0)();
          var _$prime = Gio_Settings.set_value(colorSettings)("night-light-schedule-to")(v$prime)();
      ...
      return function (env) {
          return function (show_dialog) {
              ...
              var go = function (startTime) {
                  return function (lastTimeRef) {
                      var getSetting = function (name) {
                          return Data_Functor.map(Effect.functorEffect)(Data_Int.toNumber)(Gio_Settings.get_int(settings.settings)(name));
                      };
                      var getCurveSetting = function (name) {
                          return Gio_Settings.get_double(settings.settings)(name);
                      };
                      return function __do() {
                          ...
                          Control_Applicative.unless(Effect.applicativeEffect)(env.debug)(setColor(settings.colorSettings)(Data_Int.round(newTemp)))();
              ...
              return function __do() {
                  ...
                  Control_Applicative.unless(Effect.applicativeEffect)(env.debug)(enableNightLight(settings.colorSettings))();
                  startIdleWorker(env)();
                  var startTime = GLib_DateTime.getUnix();
                  var lastTimeRef = Effect_Ref["new"](startTime)();
                  Effect_Ref.write(0)(env.idleTimeRef)();
                  var timer = GLib.timeoutAdd(1000)(go(startTime)(lastTimeRef))();
                  return Effect_Ref.write(new Data_Maybe.Just(timer))(env.timerMain)();
              };
          };
      };
  };
...
})(PS["Gnome.UI.Main"] = PS["Gnome.UI.Main"] || {});
(function($PS) {
  // Generated by purs version 0.14.1
  "use strict";
  $PS["Gnome.UI.Main"] = $PS["Gnome.UI.Main"] || {};
  var exports = $PS["Gnome.UI.Main"];
  var $foreign = $PS["Gnome.UI.Main"];   
...
(function($PS) {
  ...
  var GJS = $PS["GJS"];
  var GLib = $PS["GLib"];
  var Gnome_UI_Main = $PS["Gnome.UI.Main"];
  var St = $PS["St"];
  ...
  var remove = Gnome_UI_Main.removeChrome();
  ...
  var mkWidget = function (settings) {
      return function (env) {
          ...
          return function __do() {
              ...
              Data_Functor["void"](Effect.functorEffect)(Clutter_Actor.onButtonPressEvent()(chillButton)(onClick(bin)(Data_Function["const"](AutoChill_Worker.autoChillWorker(settings)(env)(Clutter_Actor.show()(bin))))))();
              var snoozeButton = button("Snooze")();
              Clutter_Actor.add_child()()(actionBox)(snoozeButton)();
              Data_Functor["void"](Effect.functorEffect)(Clutter_Actor.onButtonPressEvent()(snoozeButton)(onClick(bin)(snooze)))();
  ...
  var add = Gnome_UI_Main.addTopChrome();
  exports["add"] = add;
...
})(PS["Gnome.UI.PopupMenu"] = PS["Gnome.UI.PopupMenu"] || {});
(function($PS) {
  // Generated by purs version 0.14.1
  "use strict";
  $PS["Gnome.UI.PopupMenu"] = $PS["Gnome.UI.PopupMenu"] || {};
  var exports = $PS["Gnome.UI.PopupMenu"];
  var $foreign = $PS["Gnome.UI.PopupMenu"];
...
(function($PS) {
  ...
  var Gnome_UI_PopupMenu = $PS["Gnome.UI.PopupMenu"];
  var St = $PS["St"];
  var St_Icon = $PS["St.Icon"];
  var St_Label = $PS["St.Label"];                
  var $$delete = Clutter_Actor.destroy();
      ...
      return function (settings) {
          return function (env) {
              var onClick = function __do() {
                  ...
                  return AutoChill_Worker.autoChillWorker(settings)(env)(AutoChill_UIClutter.showWidget(ui))();
              };
              return function __do() {
                  var button = Gnome_UI_PanelMenu.newButton(0.0)("AutoChill")(false)();
                  ...
                  var menuItem = Gnome_UI_PopupMenu.newItem("")();
                  Gnome_UI_PopupMenu.connectActivate(menuItem)(onClick)();
                  var label = St_Label["new"]("Restart")();
                  Clutter_Actor.add_child()()(menuItem)(label)();
                  Gnome_UI_PanelMenu.addMenuItem(button)(menuItem)();
                  Gnome_UI_Main_Panel.addToStatusArea("autochill")(button)();
                  return button;
              };
          };
      };
...
(function($PS) {
  ...
  var getColorSettings = Gio_Settings["new"]("org.gnome.settings-daemon.plugins.color");
  ...
  var mkWidget = function (settings) {
      return function (env) {
          ...
          var onChilled = function (win) {
              return function __do() {
                  Gtk4.hide()(win)();
                  AutoChill_Worker.autoChillWorker(settings)(env)(Gtk4.show()(win))();
                  return Data_Unit.unit;
              };
          };
          return function __do() {
...
(function($PS) {
  ...
  var gtkApp = function (appName) {
      return function (activate) {
          return function __do() {
              ...
              var colorSettings = AutoChill_Settings.getColorSettings();
      ...
      var activate = function (loop) {
          return function (settings) {
              return function __do() {
                  ...
                  var prefWidget = AutoChill_PrefsWidget.mkPrefWidget(settings.settings)();
      ...
      var activate = function (_loop) {
          return function (settings) {
              return function __do() {
                  ...
                  var widget = AutoChill_UIGtk4.mkWidget(settings)(env)();
                  if (env.debug) {
                      return AutoChill_UIGtk4.showWidget(widget)();
                  };
                  return AutoChill_Worker.autoChillWorker(settings)(env)(AutoChill_UIGtk4.showWidget(widget))();
              };
          };
      };
  ...
  var extension = (function () {
      ...
      var enable = function (settings) {
          return function __do() {
              log("enable called")();
              var env = AutoChill_Env.createEnv(false)();
              var bin = AutoChill_UIClutter.mkWidget(settings)(env)();
              var button = AutoChill_PanelMenu.create(bin)(settings)(env)();
              AutoChill_UIClutter.add(bin)();
              AutoChill_Worker.autoChillWorker(settings)(env)(AutoChill_UIClutter.showWidget(bin))();
              Gnome_UI_Main.notify("AutoChill engaged")("")();
              return {
                  env: env,
                  bin: bin,
                  button: button
      ...
      var disable = function (uiEnv) {
          return function __do() {
              log("disable called")();
              AutoChill_PanelMenu["delete"](uiEnv.button)();
              AutoChill_UIClutter.remove(uiEnv.bin)();
              return AutoChill_Worker.stopChillWorker(uiEnv.env)();
          };
      };
      return {
          enable: enable,
...
function init() { AutoChillSettings = PS["AutoChill"]["extension"].init(); }
function enable() { AutoChillEnv = PS["AutoChill"]["extension"].enable(AutoChillSettings)(); }
function disable() { PS["AutoChill"]["extension"].disable(AutoChillEnv)(); }
