...
(function($PS) {
  ...
  var AutoChillWidget = function (widget_handler, widget_show) {
      this.widget_handler = widget_handler;
      this.widget_show = widget_show;
  };
  var widget_show = function (dict) {
      return dict.widget_show;
  };
  var widget_handler = function (dict) {
      return dict.widget_handler;
  };
  ...
  var autoChillWidget = new AutoChillWidget(function (v) {
      return function (onChilled) {
          return function (onSnooze) {
              var closeButton = function (action) {
                  return function (v1) {
                      return function (_ev) {
                          return function __do() {
                              Clutter_Actor.hide()(v.value0.bin)();
                              action();
                              return true;
                          };
                      };
              ...
              return function __do() {
                  Clutter_Actor.onButtonPressEvent()(v.value0.chillButton)(closeButton(onChilled))();
                  Clutter_Actor.onButtonPressEvent()(v.value0.snoozeButton)(closeButton(onSnooze))();
                  return Data_Unit.unit;
              };
          };
      };
  }, function (v) {
      return Clutter_Actor.show()(v.value0.bin);
  });
  exports["createEnv"] = createEnv;
  exports["AutoChillWidget"] = AutoChillWidget;
  exports["widget_show"] = widget_show;
  exports["widget_handler"] = widget_handler;
...
(function($PS) {
  ...
  var removePanelMenu = function (env) {
      return function __do() {
          ...
          (function () {
              ...
              throw new Error("Failed pattern match at AutoChill.PanelMenu (line 44, column 3 - line 46, column 45): " + [ buttonM.constructor.name ]);
          })();
  ...
  var addPanelMenu = function (env) {
      var onClick = function __do() {
          GJS.log("Restart")();
          return Effect_Ref.write(true)(env.reset)();
      };
      return function __do() {
...
(function($PS) {
  ...
  exports["get_boolean"] = $foreign.get_boolean;
...
(function($PS) {
  ...
  var remove = function (env) {
      return function __do() {
          ...
          if (uiM instanceof Data_Maybe.Just) {
              return ShellUI_Main.removeChrome()(uiM.value0.value0.bin)();
          };
          if (uiM instanceof Data_Maybe.Nothing) {
              return GJS.log("[E] ui is undefined")();
          };
          throw new Error("Failed pattern match at AutoChill.UIClutter (line 36, column 3 - line 38, column 45): " + [ uiM.constructor.name ]);
      };
  };
  ...
  var mkWidget = function __do() {
      ...
      return new AutoChill_Env.Widget({
          bin: bin,
          chillButton: chillButton,
  ...
  var add = function (env) {
      return function __do() {
          var uiM = Effect_Ref.read(env.ui)();
          if (uiM instanceof Data_Maybe.Just) {
              return ShellUI_Main.addTopChrome()(uiM.value0.value0.bin)();
          };
          if (uiM instanceof Data_Maybe.Nothing) {
              return Data_Unit.unit;
          };
          throw new Error("Failed pattern match at AutoChill.UIClutter (line 29, column 3 - line 31, column 25): " + [ uiM.constructor.name ]);
      };
  };
  exports["init"] = init;
  exports["add"] = add;
...
(function($PS) {
  ...
  var autoChillWidget = new AutoChill_Env.AutoChillWidget(function (v) {
      return function (onChilled) {
          return function (onSnooze) {
              var closeButton = function (action) {
                  return function __do() {
                      Gtk4.hide()(v.value0.win)();
                      return action();
                  };
              };
              return function __do() {
                  GObject.signal_connect_closure()(v.value0.chillButton)("clicked")(closeButton(onChilled))();
                  GObject.signal_connect_closure()(v.value0.snoozeButton)("clicked")(closeButton(onSnooze))();
                  return Data_Unit.unit;
              };
          };
      };
  }, function (v) {
      return Gtk4.show()(v.value0.win);
  });
...
(function($PS) {
  ...
  var simpleCall = function ($$interface) {
      return function (path) {
          return function (method) {
              return function (writeCb) {
                  ...
                  return Gio_DBusConnection.call(Gio_DBusConnection.session)(new Data_Maybe.Just($$interface))(path)($$interface)(method)(Data_Maybe.Nothing.value)(Data_Maybe.Nothing.value)(Gio_DBusCallFlags.none)(200)(Data_Maybe.Nothing.value)(new Data_Maybe.Just(cb));
              };
          };
      };
  };
  var isScreenLocked = function (ref) {
      var writeCb = function (variant) {
          return function __do() {
              var value = GLib_Variant.get_boolean(variant)();
              return Effect_Ref.write(value)(ref)();
          };
      };
      return simpleCall("org.gnome.ScreenSaver")("/org/gnome/ScreenSaver")("GetActive")(writeCb);
  };
  var getIdleTime = function (ref) {
      var writeCb = function (variant) {
          return function __do() {
      ...
      return simpleCall("org.gnome.Mutter.IdleMonitor")("/org/gnome/Mutter/IdleMonitor/Core")("GetIdletime")(writeCb);
  };
...
(function($PS) {
  ...
  var stopChillWorker = function (env) {
      return function __do() {
          var timerM = Effect_Ref.read(env.timer)();
          ...
          throw new Error("Failed pattern match at AutoChill.Worker (line 35, column 3 - line 37, column 43): " + [ timerM.constructor.name ]);
      };
  };
  ...
  var autoChillWorker = function (dictAutoChillWidget) {
      return function (env) {
          return function (widget) {
              return function (resetRef) {
                  return function (debug) {
                      return function (settings) {
                          ...
                          var snoozeDelay = 5 * minute_msec | 0;
                          var onSnooze = function (colorSettings) {
                              return function __do() {
                                  GJS.log("Asking again in " + Data_Show.show(Data_Show.showInt)(snoozeDelay))();
                                  return Data_Functor["void"](Effect.functorEffect)(GLib.timeoutAdd(snoozeDelay)(function __do() {
                                      AutoChill_Env.widget_show(dictAutoChillWidget)(widget)();
                                      return false;
                                  }))();
                              };
                          };
                          ...
                          var go = function (screenLockedRef) {
                              return function (idleTimeRef) {
                                  return function (colorSettings) {
                                      return function (startTime) {
                                          return function __do() {
                                              var now = GLib_DateTime.getUnix();
                                              AutoChill_DBus.isScreenLocked(screenLockedRef)();
                                              AutoChill_DBus.getIdleTime(idleTimeRef)();
                                              ...
                                              var screenLocked = Effect_Ref.read(screenLockedRef)();
                                              var idleTime = Effect_Ref.read(idleTimeRef)();
                                              var reset = Effect_Ref.read(resetRef)();
                                              ...
                                              var shouldStop = elapsed >= duration || (screenLocked || (idle || reset));
                                              GJS.log("AutoChill running for " + (Data_Show.show(Data_Show.showNumber)(elapsed) + (" sec (" + (Data_Show.show(Data_Show.showNumber)(elapsedNorm) + ") ")) + (" idle: " + Data_Show.show(Data_Show.showInt)(idleTime) + (" temp: " + (Data_Show.show(Data_Show.showNumber)(newTemp) + (" (" + (Data_Show.show(Data_Show.showNumber)(newTempNorm) + ") ")) + ((function () {
                                                  if (screenLocked) {
                                                      return " screenlocked";
                                                  };
                                                  return "";
                                              ...
                                              if (shouldStop) {
                                                  Control_Applicative.unless(Effect.applicativeEffect)(debug)(setColor(colorSettings)(Data_Int.round(newTemp)))();
                                                  Effect_Ref.write(false)(resetRef)();
                                                  AutoChill_Env.widget_show(dictAutoChillWidget)(widget)();
                                                  return false;
                                              };
                                              return true;
                          ...
                          var startAutoChill = function (colorSettings) {
                              return function (startTime) {
                                  return function __do() {
                                      Effect_Ref.write(false)(resetRef)();
                                      var screenLockedRef = Effect_Ref["new"](false)();
                                      var idleTimeRef = Effect_Ref["new"](0)();
                                      var timer = GLib.timeoutAdd(1000)(go(screenLockedRef)(idleTimeRef)(colorSettings)(startTime))();
                                      Effect_Ref.write(new Data_Maybe.Just(timer))(env.timer)();
                                      return Data_Unit.unit;
                                  };
                              };
                          };
                          var onChilled = function (colorSettings) {
                              return function __do() {
                                  GJS.log("Ah darn, here we go again")();
                                  var startTime$prime = GLib_DateTime.getUnix();
                                  return Data_Functor["void"](Effect.functorEffect)(startAutoChill(colorSettings)(startTime$prime))();
                              };
                          };
                          return function __do() {
                              var colorSettings = Gio_Settings["new"]("org.gnome.settings-daemon.plugins.color")();
                              AutoChill_Env.widget_handler(dictAutoChillWidget)(widget)(onChilled(colorSettings))(onSnooze(colorSettings))();
                              Control_Applicative.unless(Effect.applicativeEffect)(debug)(enableNightLight(colorSettings))();
                              var startTime = GLib_DateTime.getUnix();
                              if (debug) {
                                  return AutoChill_Env.widget_show(dictAutoChillWidget)(widget)();
                              };
                              return startAutoChill(colorSettings)(startTime)();
                          };
                      };
                  };
              };
...
(function($PS) {
  ...
  var gtkApp = function (appName) {
      return function (activate) {
          return function __do() {
              var settings = AutoChill_Settings.getSettingsFromPath("./dist/schemas")();
  ...
  var standalone = function (debug) {
      var activate = function (_loop) {
          return function (settings) {
              return function __do() {
                  var env = AutoChill_Env.createEnv();
                  var reset = Effect_Ref["new"](false)();
                  var widget = AutoChill_UIGtk4.mkWidget();
                  return AutoChill_Worker.autoChillWorker(AutoChill_UIGtk4.autoChillWidget)(env)(widget)(reset)(debug)(settings)();
              };
          };
      };
  ...
  var enable = function (env) {
      return function __do() {
          ...
          if (widgetM instanceof Data_Maybe.Just) {
              AutoChill_Worker.autoChillWorker(AutoChill_Env.autoChillWidget)(env)(widgetM.value0)(env.reset)(false)(settings)();
              return ShellUI_Main.notify("AutoChill engaged")("")();
          };
          if (widgetM instanceof Data_Maybe.Nothing) {
              return GJS.log("oops, empty widget")();
          };
          throw new Error("Failed pattern match at AutoChill (line 43, column 3 - line 47, column 40): " + [ widgetM.constructor.name ]);
      };
  };
  ...
  var create = AutoChill_Env.createEnv;
